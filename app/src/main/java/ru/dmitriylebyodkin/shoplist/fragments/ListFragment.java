...
//            etSearch.clearFocus();
    ...
    public void setActivityTitle(String title) {
        ((InfoView) getActivity()).setActivityTitle(title);
    }
    ...
    public int getPositionOpened() {
        return adapter.getPositionOpened();
    }
    ...
    public void setPositionOpened(int position) {
        adapter.setPositionOpened(position);
    }
}
